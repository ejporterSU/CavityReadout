...
| 015 | [heterodyne-toggles](015-heterodyne-toggles-triggered.md) | 2026-06-03 | Heterodyne viewer follow-ups: per-pane show/hide toggles for the two demod tones; phase pane adds a summed-phase trace (off by default, ±2π); Run/Single never auto-trigger — both acquire single-shot waiting for a real trigger, Run re-arms a single per analyzed frame ("Waiting for trigger…" during gaps) |
